  ...
  return (
    ...
    >
      <main className="max-h-screen h-screen noScroll overflow-y-scroll w-[32rem] max-w-full bg-[rgb(27,36,48)] flex flex-col relative">
        ...
        <div className="bottom bg-gray-800 flex-grow relative">
          ...
          <Link href="/vFs56Dmd2P">
            <a className="p-4 inline-block absolute bottom-3 right-1/2 translate-x-1/2  rounded-full" />
          </Link>
        </div>
      </main>
    </section>
