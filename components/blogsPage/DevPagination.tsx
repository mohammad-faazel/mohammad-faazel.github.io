...
export default function DevPagination({
    ...
    function changePage(nextPage: number) {
        ...
        onLoadMore(
            `https://dev.to/api/articles?tags=javascript,wordpress&per_page=${postsPerPage}&page=${nextPage}`
        );
    }
    ...
    return (
        <div className="p-5 rounded-lg bg-[#0e1422d9] flex justify-center items-center gap-7">
            ...
            >
                <FiChevronLeft className="text-3xl rtl:rotate-180" />
                Prev
            </button>
            ...
            >
                Next
                <FiChevronRight className="text-3xl rtl:rotate-180" />
            </button>
        </div>
    );
}
